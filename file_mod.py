...
def git_sync():
    ...
    if is_windows:
        # --- LOCAL WINDOWS ENVIRONMENT (Pure Standard Tracking) ---
        output_log += "[System] Local Windows environment detected...\n"
        ...
        # --- PYTHONANYWHERE SERVER ENVIRONMENT (Master-to-Main Mapping) ---
        output_log += "[System] PythonAnywhere server environment detected...\n"
